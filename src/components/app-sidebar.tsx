...
const primaryGroups: GroupNode[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Arbeidsgiveranalyser", to: "/employers" },
      { label: "Vurdering av arbeidsgivere", to: "/vurdering-av-arbeidsgivere" },
    ],
    matchPrefixes: ["/marked", "/employers", "/vurdering-av-arbeidsgivere"],
  },
  {
    id: "jobs",
    label: "Jobber",
