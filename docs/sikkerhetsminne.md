...
Unntaket gjelder **kun** funksjonene som er navngitt nedenfor, vurdert 2026-08-24. Funksjoner som ikke står på listen er reelt nye funn og skal vurderes på nytt, selv om de havner i samme advisor-kategori.

Kallbare av `anon` (og `authenticated`) — triggerfunksjoner, offentlig registeroppslag og funksjoner som selv sjekker `auth.uid()`:

`career_atom_links_guard`, `career_atoms_eksponering_parent_check`, `career_atoms_recheck_links_trigger`, `count_employers`, `cv_atomization_job_cancel`, `cv_atomization_job_resume`, `cv_claim_attestation_after_write`, `cv_claim_attestation_before_write`, `cv_claim_attestation_set_version`, `cv_claim_invalidate_attestation`, `cv_review_basis_reconcile`, `cv_review_promote_result`, `cv_review_set_role_choice`, `delete_all_my_data`, `employer_ansatte_distribution`, `get_employer_analysis_view`, `get_employer_detail`, `get_employer_formaal`, `get_employer_regnskap_history`, `has_role`, `network_company_reconciliation_confirm`, `network_company_reconciliation_scan`, `network_company_reconciliation_set_state`, `search_employers`.

Kallbare av `authenticated` — brukerens egne operasjoner, alle scopet internt på `auth.uid()`:

`career_atom_add_manual_result`, `career_atom_link_decide`, `career_atom_link_override`, `career_atom_link_suggest`, `career_atom_links_mark_recheck`, `career_atom_project_evidence`, `career_atom_project_parent`, `career_atom_promote_parse_candidate`, `cv_review_progress_advance`, `cv_review_progress_sync`, `employer_review_ensure_target`, `employer_review_ensure_target_by_orgnr`, `employer_review_moderate`, `employer_review_search_status`, `employer_review_submit`, `employer_review_withdraw`, `get_admin_ingestion_status`, `get_employer_analysis_benchmark_report`, `get_employer_analysis_weight_config`, `get_employer_review_aggregate`, `get_my_employer_review`, `get_user_employers`, `internal_ai_get_cv_generation`, `linkedin_promote_career_record`, `linkedin_promote_job_preference`, `linkedin_promote_network_contact`, `linkedin_promote_profile_field`, `linkedin_promote_qualification`, `linkedin_promote_recommendation`, `linkedin_promote_saved_job`, `linkedin_promote_skill_or_signal`, `linkedin_promotion_record_failure`, `linkedin_promotion_reopen`, `linkedin_reconciliation_decide`, `list_regnskap_cron_runs`, `list_user_careerjet_leads`, `list_user_job_opportunities`, `match_user_opportunities_from_mirror`, `network_link_recommendation_contact`, `network_unlink_recommendation_contact`, `network_update_contact_contact_points`, `network_update_contact_manual_profile`, `register_lead`, `reset_my_employer_analysis_weights`, `review_employer_analysis_model_run`, `set_employer_analysis_weight_profile`, `set_my_employer_analysis_weights`.
