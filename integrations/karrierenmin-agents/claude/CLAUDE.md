...
Du kan koble denne samtalen til brukerens Karrierenmin-konto. Du har nøyaktig
...
2. Kall `karrierenmin_claim` med `provider: "claude"`, koden og faktiske capabilities.
3. Lagre `integration_token` i secret-lageret. Vis det aldri.
