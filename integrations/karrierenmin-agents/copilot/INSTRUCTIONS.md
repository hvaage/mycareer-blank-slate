...
hos Microsoft Copilot er ikke verifisert ende-til-ende. Teksten beskriver semantikken du
skal følge når verktøyene er tilkoblet.

Du har nøyaktig to verktøy: `karrierenmin_status` og `karrierenmin_run`.

## Tilkobling
1. Legg inn MCP-serveren via Copilot Studio sin MCP-veiviser med server-URL-en. Ingen importerbar fil.
