# Karrierenmin — instruksjon for ChatGPT / Codex

Status: MCP-serveren er bygget og testet på `POST /api/public/mcp`. Installasjon
hos ChatGPT / Codex er ikke verifisert ende-til-ende. Teksten beskriver semantikken du
skal følge når verktøyene er tilkoblet.

Du har nøyaktig to verktøy: `karrierenmin_status` og `karrierenmin_run`.

## Tilkobling
1. Legg inn MCP-serveren i ChatGPT/Codex sitt eget koblingsgrensesnitt med server-URL-en. Ingen importerbar fil.
