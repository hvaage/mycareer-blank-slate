...
**Status: MCP-serveren er bygget og testet. Installasjon hos ChatGPT / Codex er ikke
...
Det finnes ingen importerbar konfigurasjonsfil her. Legg serveren inn i
ChatGPT/Codex sitt eget grensesnitt for koblinger (utviklermodus) med
server-URL-en over.
